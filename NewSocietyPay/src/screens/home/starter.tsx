...
const Home = () => {
  ...
  const [mode, setMode] = useState< "guest"| "login"| "register" | "member"| "landing" >("landing");
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.hero}>
        ...
        <Text style={styles.heroText}>
          Smart payments, smarter societies.
        </Text>
      </View>

      <View style={styles.cards}>
        <Card title="💳 Easy Payments" desc="Pay maintenance & dues instantly." />
